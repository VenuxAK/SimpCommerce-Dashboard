  ...
  >
    <div class="flex h-14 items-center px-4 border-b border-border/50">
      ...
      <button
        ...
        class="ml-auto hidden lg:flex items-center justify-center size-6 rounded-md hover:bg-sidebar-accent text-sidebar-muted transition-colors"
      >
    ...
    <div class="p-2 border-t border-border/50">
      <button
        @click="handleLogout"
        class="flex items-center rounded-md px-3 py-2 text-xs font-medium text-sidebar-muted transition-all hover:bg-sidebar-accent hover:text-destructive group w-full cursor-pointer"
